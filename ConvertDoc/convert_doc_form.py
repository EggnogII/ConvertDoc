...
class convert_doc_gui:
    def __init__(self, master):
        ...
        self.convert_to_docx_button = Button(master, text="Convert MD to DOCX", command=lambda : self.convert_markdown_to_docx_button())
    ...
    def convert_markdown_to_docx_button(self):
        # Initialize Progress Bar Value
        self.progress_bar["value"] = 0
        self.progress_bar["maximum"] = 100

        # Select a Markdown File
        input_filename = convert_doc_controller.document_selector(selection_title="Select Markdown File", filetype="md")
